      ...
      <Dialog.Content className="fixed bg-[#2A2634] py-8 px-10 text-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-lg w-[480px] shadow-lg shadow-black/25">
        <Dialog.Title className="text-3xl font-black">Post an ad</Dialog.Title>
          ...
          <form onSubmit={handleCreateAd} className="mt-8 flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-2">
              <label htmlFor="name"> Your name inside the game</label>
              <Input name="name" id="name" placeholder="Your nickname" />
            </div>

            <div className="grid grid-cols-2 gap-6">
              <div className="flex flex-col gap-2">
                <label htmlFor="yearsPlaying">How old do you play ?</label>
                <Input name="yearsPlaying" id="yearsPlaying" type="number" placeholder="It's okay to be zero" />
              </div>
              <div className="flex flex-col gap-2">
